...
| ----- | --------- | ---------------- |
| An e-commerce URL (Amazon, Shopify, AliExpress, any product page) | `references/url-extract.md` | A 150–300 word description + up to 5 downloaded, filtered product images |
...
Do **not** decide the product's tier (luxury / premium / drugstore) — that's the calling skill's call,
made from packaging cues. Your job is the objective facts.
