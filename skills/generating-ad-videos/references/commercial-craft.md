...
- **Spoken lines** — any spoken line is a voiceover over the picture, never lip-synced on camera. A voiceover the user wants as a separate track is made with `generating-audio`.
